...
describe('the reconcile loop', () => {
  ...
  it('reports a card held to the reader as one event carrying the whole tag', async () => {
    ...
    space.device.addToLog('D', 0xa1b2 % 32767)
    space.device.addToLog('d', Math.floor(0xa1b2 / 32767))
